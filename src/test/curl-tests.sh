...
echo "-"
curl --fail -i -X POST http://0.0.0.0:8080/add -H 'Content-Type: application/json' -d '{"service":"infrasvc","event":"deploy-infrasvc-v0.0.2", "eventType":"deploy-qa", "Datetime":"2022-07-02 00:00:00"}'
echo "-"
